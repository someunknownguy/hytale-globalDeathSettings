...
- "Configured" to only drop certain configured items from your inventory, respecting the other 2 config items (have yet to find where the list of dropped items is configured) 
